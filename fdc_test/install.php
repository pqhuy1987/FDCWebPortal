...
$_SESSION['INSTALL']['db_user'] = 'root';
$_SESSION['INSTALL']['db_pass'] = '';
$_SESSION['INSTALL']['db_driver'] = 'mysql';
$_SESSION['INSTALL']['db_db'] = 'sinhvienit_tracnghiem';
$_SESSION['INSTALL']['table_prefix'] = 'tracnghiem_';
$_SESSION['INSTALL']['title_postfix'] = 'SinhVienIT.Net | Mạng giải trí, học tập trực tuyến tốc đô nhanh !';
