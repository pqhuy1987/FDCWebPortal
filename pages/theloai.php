        ...
        <div class="cat-content">
        	<div class="col1">
            	<div class="news">
                    ...
                    <img class="images_news" src="<?php if($row_TinMoiNhat_TheoLoaiTin_MotTin['urlHinh']==null) echo '../cms/images/temp_image.jpg';  else echo $row_TinMoiNhat_TheoLoaiTin_MotTin['urlHinh']?>" align="left" />
