...
function ft_settings_external_load() {
  ...
  $ft["settings"]["DIR"]               = "../upload"; // Your default directory. Do NOT include a trailing slash!
  ...
  $ft["settings"]["PLUGINDIR"]         = '../admin_file_mng/plugins'; // Set to the path to your plugin folder. Do NOT include a trailing slash!
