        ...
        <div class="cat-content">
        	<div class="col0 col1">
            	<div class="news">
                    ...
                    <img class="images_news" src="<?php if($row_ChonTin_Theo_TenLoanTin_PhanTrang['urlHinh']==null) echo '../cms/images/temp_image.jpg';  else echo $row_ChonTin_Theo_TenLoanTin_PhanTrang['urlHinh']?>" align="left" />
